...
* Forked from [mongoose-paginate](https://github.com/edwardhotchkiss/mongoose-paginate)
* Changed name to mongo-pages to reflect changes by Rob Crocombe
* Changed signature of paginate function
    * Options are placed before callback, including page and limit
    * Results returned as an Object
* Added lean() feature
* Auto-beautified code files
